...
def pilih_super():
	...
	if peak =="":
		...
		print "\x1b[1;91mFill in correctly"
		pilih_super()
	somi = raw_input('\x1b[1;92m lType Any Password No1  ')
        somii = raw_input('\x1b[1;92m Type Any Password No2  ')
        somiii = raw_input('\x1b[1;92m Type Any Password No4: ')
        somiiii = raw_input('\x1b[1;92m Type Any Password No5:')
        somiiiii = raw_input('\x1b[1;92m Type Any Password No2: ')
